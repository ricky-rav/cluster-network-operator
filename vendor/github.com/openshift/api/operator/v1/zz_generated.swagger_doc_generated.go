...
var map_GatewayConfig = map[string]string{
	...
	"v4InternalMasqueradeSubnet": "V4InternalMasqueradeSubnet contains the v4 masquerade addresses used internally by ovn-kubernetes to enable host to service traffic. The host is configured with these addresses, as well as the shared gateway bridge interface.The values can be changed after installation. The default subnet is 169.254.169.0/29",
	"v6InternalMasqueradeSubnet": "V6InternalMasqueradeSubnet contains the v6 masquerade addresses used internally by ovn-kubernetes to enable host to service traffic. The host is configured with these addresses, as well as the shared gateway bridge interface.The values can be changed after installation. The default subnet is fd69::/125",
}
